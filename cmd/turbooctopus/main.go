...
import (
	"fmt"
	callbackManager "github.com/ethereum/go-ethereum/callback_manager"
	nodeManager "github.com/ethereum/go-ethereum/node_manager"
	"os"
	"sort"
	"strconv"
	"strings"
...
func geth(ctx *cli.Context) error {
	...
	callbackManager.RegisterCallBack("GetHandshakeInfo", nodeManager.GetHandshakeInfo)
